...
//$command = $ckan_client->getCommand('GetPackageRelationshipsList');

$command = $ckan_client->getCommand('GetPackageRelationshipsList', array('id' => 'abitazioni-in-affitto', 'id2' => 'abitazioni-occupate'));
